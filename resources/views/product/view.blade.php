            ...
            <div class="p-6 text-gray-900 dark:text-gray-100">
                ...
                <div class="rounded-lg border border-gray-200 dark:border-gray-700 divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <div class="flex items-center px-5 py-4">
                        <div class="w-32 shrink-0 text-gray-500 dark:text-gray-400">Product Name</div>
                        <div class="text-sm font-semibold text-gray-900 dark:text-gray-100">{{ $product->name }}</div>
                    </div>

                    {{-- Quantity --}}
                    <div class="flex items-center px-5 py-4">
                        <div class="w-32 shrink-0 text-gray-500 dark:text-gray-400">Quantity</div>
                        <div>
                    ...
                    {{-- Price --}}
                    <div class="flex items-center px-5 py-4">
                        <div class="w-32 shrink-0 text-gray-500 dark:text-gray-400">Price</div>
                    ...
                    {{-- Owner --}}
                    <div class="flex items-center px-5 py-4">
                        <div class="w-32 shrink-0 text-gray-500 dark:text-gray-400">Owner</div>
                        <div class="flex items-center gap-2">
                    ...
                    {{-- Created At --}}
                    <div class="flex items-center px-5 py-4">
                        <div class="w-32 shrink-0 text-gray-500 dark:text-gray-400">Created At</div>
                        <div class="text-sm text-gray-600 dark:text-gray-300">
                            {{ $product->created_at->format('d M, H:i') }}
                        </div>
                    </div>

                    {{-- Updated At --}}
                    <div class="flex items-center px-5 py-4">
                        <div class="w-32 shrink-0 text-gray-500 dark:text-gray-400">Updated At</div>
                        <div class="text-sm text-gray-600 dark:text-gray-300">
                            {{ $product->updated_at->format('d M, H:i') }}
                        </div>
                    </div>
